...
import { UserBoardsPagination } from "./UserBoardsPagination";
...
import { DeleteBoardDialog } from "@/app/user-boards/(board-management)/_components/board-table/DeleteBoardDialog";
import { BoardDetailsButton } from "@/app/user-boards/(board-management)/_components/board-table/BoardDetailsButton";
