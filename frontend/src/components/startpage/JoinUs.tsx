...
const CallToAction: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] bg-palette1-darkest-blue-template1 text-palette1-creme-light relative lg:bottom-[100px]">
      <h2 className="text-5xl font-bold mb-4 text-#292929" style={{letterSpacing:'1.8px'}}>Join Us!</h2>
      <div className="relative w-64 h-64 mb-8 rounded-lg overflow-hidden border-2 border-palette1-creme-strong">
        <Image
          src={imageUrl}
          alt="Join Us"
          quality={75}
