...
const MissionStatement: React.FC = () => {
  return (
    <section className="py-8 px-4 min-h-[90vh] relative  text-xl   bg-palette1-blue lg:clip-mission-statement flex flex-col justify-center lg:clip-mission-statement">
      <div className="lg:w-7/12 md:w-55 relative z-10 flex flex-col gap-4 text-palette1-cream-template1">
        ...
        <p className="mb-5 leading-9" style={{ letterSpacing:"1.2px"}}>
