...
const Sidebar: FC = () => {
  return (
      ...
      <div className="relative flex flex-col  bg-white border-r group hover:w-52 w-[56px] w-min-[56px] transition-all  duration-300 ease-in-out overflow-hidden" style={{
