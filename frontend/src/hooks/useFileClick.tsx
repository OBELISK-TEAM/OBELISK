...
const useFileClick = (activeItem: string | null, setActiveItem: (item: string | null) => void, fileInputRef: React.RefObject<HTMLInputElement>, fileJSONInputRef: React.RefObject<HTMLInputElement>) => {
  useEffect(() => {
